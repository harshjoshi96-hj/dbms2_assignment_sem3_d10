-- UNIT 3 CURSOR EXERCISES - SCHEMA SETUP
-- Run this file once before running the P3.x cursor programs.
...
CREATE TABLE book_issue (
    ...
    CONSTRAINT fk_issue_member FOREIGN KEY (member_id) REFERENCES lib_member (member_id)
);
...
-- Verification: publisher=5, book=12, lib_member=8, book_issue=12
